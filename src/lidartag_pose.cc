...
namespace BipedLab {
    ...
    Eigen::VectorXd d_px_euler(double x11, double y11, double z11, double rpy11, double rpy12, double rpy13) {
        ...
        d_px << 1.0, 0.0, 0.0, 0.0,
             ...
             t4*M_PI*(x11*t7+y11*t5)*(-1.0/1.8e+2); return d_px;
    }
    ...
    Eigen::VectorXd d_py_euler(double x11, double y11, double z11, double rpy11, double rpy12, double rpy13) {
        ...
        d_py << 0.0, 1.0, 0.0, -x11*((t8*t10*M_PI)/1.8e+2-(t5*t7*t9*M_PI)/1.8e+2)-y11*((t7*t8*M_PI)/1.8e+2+(t5*t9*t10*M_PI)/1.8e+2)-(z11*t5*t6*M_PI)/1.8e+2,(t8*M_PI*(z11*t9+x11*t6*t7-y11*t6*t10))/1.8e+2,x11*((t5*t7*M_PI)/1.8e+2-(t8*t9*t10*M_PI)/1.8e+2)-y11*((t5*t10*M_PI)/1.8e+2+(t7*t8*t9*M_PI)/1.8e+2);
        return d_py;
    }
    ...
    Eigen::VectorXd d_pz_euler(double x11, double y11, double z11, double rpy11, double rpy12, double rpy13) {
        ...
        d_pz << 0.0, 0.0, 1.0, x11*((t5*t10*M_PI)/1.8e+2+(t7*t8*t9*M_PI)/1.8e+2)+y11*((t5*t7*M_PI)/1.8e+2-(t8*t9*t10*M_PI)/1.8e+2)-(z11*t6*t8*M_PI)/1.8e+2, t5*M_PI*(z11*t9+x11*t6*t7-y11*t6*t10)*(-1.0/1.8e+2), x11*((t7*t8*M_PI)/1.8e+2+(t5*t9*t10*M_PI)/1.8e+2)-y11*((t8*t10*M_PI)/1.8e+2-(t5*t7*t9*M_PI)/1.8e+2);
        return d_pz;
    }

    void d_px_lie_mat(
            const Eigen::MatrixXf &X1,
            const Eigen::MatrixXf &Y1,
            const Eigen::MatrixXf &Z1,
            const double &r11, const double &r12, const double &r13,
            Eigen::MatrixXf &dx_mat) {
        ...
        dx_mat.row(3) = Y1 * (-r12 * t15 * t22 -
                            r13 * t2 *t5 * t15 * t20 +
                            r13 * t2 * t5 * t19 * t21 +
                            r11 * r12 * t2 * t5 * t16 * t22 * 2 +
                            r11 * r12 * t2 * t5 * t19 * t21) +
                        Z1 * (-r13 * t15 * t22 +
                            r12 * t2 * t5 * t15 * t20 -
                            r12 * t2 * t5 * t19 * t21 + r11 * r13 * t2 * t5 * t16 * t22 * 2 + r11 * r13 * t2 * t5 * t19 * t21) - X1 * (t2 * t5 * t13 * t16 *t22 * 2 + t2 * t5 * t13 * t19 * t21);

        dx_mat.row(4) = -X1 * (r12 * t15 * t22 * (-2) +
                            t3 * t6 * t13 * t16 * t22 * 2 +
                            t3 * t6 * t13 * t19 * t21) +
                        Y1 * (t25 -
                            r13 * t3 * t6 * t15 * t20 +
                            r13 * t3 * t6 * t19 * t21 +
                            r11 * r12 * t3 * t6 * t16 * t22 * 2 +
                            r11 * r12 * t3 * t6 * t19 * t21) +
                        Z1 * (t23 +
                            r12 * t3 * t6 * t15 * t20 -
                            r12 * t3 * t6 * t19 * t21 +
                            r11 * r13 * t3 * t6 * t16 * t22 * 2 +
                            r11 * r13 * t3 * t6 * t19 * t21);

        dx_mat.row(5) = -X1 * (r13 * t15 * t22 * (-2) +
                            t4 * t7 * t13 * t16 * t22 * 2 +
                            t4 * t7 * t13 * t19 * t21) +
                        Y1 * (-t23 -
                            r13 * t4 * t7 * t15 * t20 +
                            r13 * t4 * t7 * t19 * t21 +
                            r11 * r12 * t4 * t7 * t16 * t22 * 2 +
                            r11 * r12 * t4 * t7 * t19 * t21) +
                        Z1 * (t25 +
                            r12 * t4 * t7 * t15 * t20 -
                            r12 * t4 * t7 * t19 * t21 +
                            r11 * r13 * t4 * t7 * t16 * t22 * 2 +
                            r11 * r13 * t4 * t7 * t19 * t21);
    }
    ...
    d_py_lie_mat(
        ...
        dy_mat.row(3) = -Y1 * (r11 * t15 * t22 * (-2) +
                            t2 * t5 * t13 * t16 * t22 * 2 +
                            t2 * t5 * t13 * t19 * t21) +
                        Z1 * (-t23 -
                            r11 * t2 * t5 * t15 * t20 +
                            r11 * t2 * t5 * t19 * t21 +
                            r12 * r13 * t2 * t5 * t16 * t22 * 2 +
                            r12 * r13 * t2 * t5 * t19 * t21) +
                        X1 * (t25 +
                            r13 * t2 * t5 * t15 * t20 -
                            r13 * t2 * t5 * t19 * t21 +
                            r11 * r12 * t2 * t5 * t16 * t22 * 2 +
        ...
        dy_mat.row(4) = X1 * (-r11 * t15 * t22 + r13 * t3 * t6 * t15 * t20 -
                            r13 * t3 * t6 * t19 * t21 +
                            r11 * r12 * t3 * t6 * t16 * t22 * 2 +
                            r11 * r12 * t3 * t6 * t19 * t21) +
                        Z1 * (-r13 * t15 * t22 -
                            r11 * t3 * t6 * t15 * t20 +
                            r11 * t3 * t6 * t19 * t21 +
                            r12 * r13 * t3 * t6 * t16 * t22 * 2 +
                            r12 * r13 * t3 * t6 * t19 * t21) -
                        Y1 * (t3 * t6 * t13 * t16 * t22 * 2 +
                            t3 * t6 * t13 * t19 * t21);

        dy_mat.row(5) = -Y1 * (r13 * t15 * t22 * (-2) +
                            t4 * t7 * t13 * t16 * t22 * 2 +
                            t4 * t7 * t13 * t19 * t21) +
                        X1 * (t23 +
                            r13 * t4 * t7 * t15 * t20 -
                        ...
                        Z1 * (t25 -
                            r11 * t4 * t7 * t15 * t20 +
                            r11 * t4 * t7 * t19 * t21 +
                            r12 * r13 * t4 * t7 * t16 * t22 * 2 +
                            r12 * r13 * t4 * t7 * t19 * t21);
    ...
    d_pz_lie_mat(
        ...
        dz_mat.row(3) = -Z1 * (r11 * t15 * t22 * (-2) +
                            t2 * t5 * t13 * t16 * t22 * 2 +
                            t2 * t5 * t13 * t19 * t21) +
                        X1 * (t25 -
                            r12 * t2 * t5 * t15 * t20 +
                            r12 * t2 * t5 * t19 * t21 +
                            r11 * r13 * t2 * t5 * t16 * t22 * 2 +
                            r11 * r13 * t2 * t5 * t19 * t21) +
                        Y1 * (t23 +
                            r11 * t2 * t5 * t15 * t20 -
                            r11 * t2 * t5 * t19 * t21 +
                            r12 * r13 * t2 * t5 * t16 * t22 * 2 +
        ...
        dz_mat.row(5) = X1 * (-r11 * t15 * t22 -
                        ...
                        Y1 * (-r12 * t15 * t22 +
                            ...
                            r12 * r13 * t4 * t7 * t16 * t22 * 2 +
                            r12 * r13 * t4 * t7 * t19 * t21) -
                        Z1 * (t4 * t7 * t13 * t16 * t22 * 2 +
                            t4 * t7 * t13 * t19 * t21);
    }

    void
    d_px_euler_mat(
            const Eigen::MatrixXf &x11,
            const Eigen::MatrixXf &y11,
            const Eigen::MatrixXf &z11,
            const double &rpy11, const double &rpy12, const double &rpy13,
            Eigen::MatrixXf &dx_mat) {
    ...
    d_py_euler_mat(
        ...
        dy_mat.row(3) =
            ...
            (-x11 * (t8 * t10 - t5 * t7 * t9) -
             ...
             z11 * t5 * t6);
        dy_mat.row(4) =
            t8 * (z11 * t9 + x11 * t6 * t7 - y11 * t6 * t10);
        dy_mat.row(5) =
            (x11 * (t5 * t7 - t8 * t9 * t10) - y11 * (t5 * t10 + t7 * t8 * t9));
    }
    ...
    d_pz_euler_mat(
        ...
        dz_mat.row(3) =
            (x11 * (t5 * t10 + t7 * t8 * t9) +
             ...
             z11 * t6 * t8);
        dz_mat.row(4) =
            -t5 * (z11 * t9 + x11 * t6 * t7 - y11 * t6 * t10);
        dz_mat.row(5) =
            (x11 * (t7 * t8 + t5 * t9 * t10) -
             y11 * (t8 * t10 - t5 * t7 * t9));
    }
    ...
    double getCost(
            const Eigen::Vector4f &template_bound,
            Eigen::MatrixXf &transformed_points) {

        Eigen::MatrixXf transfomed_cost_ary =
            (transformed_points.cwiseAbs()).colwise() - template_bound;
    ...
    double computeCost_lie(
        ...
        double cost = evaluateCost(H, (*d).topLeftCorner(4, num_points), (*d).col(num_points),
                     transfomed_points_mat);
        ...
        Eigen::Matrix<float, 1, Eigen::Dynamic>
            transformed_points_ind(1, 3*(num_points)); // 1 x 3n
        ...
        if (!grad.empty()) {
            ...
            d_px_lie_mat(
                transfomed_points_mat.row(0),
                transfomed_points_mat.row(1),
                transfomed_points_mat.row(2), x[3], x[4], x[5],
                dx_mat); // 6 x n
    ...
    int LiDARTag::_optimizePose(ClusterFamily_t &cluster){
        ...
        // box_width, tag size
        Eigen::Vector4f template_bound(
                0.02, cluster.tag_size / 2, cluster.tag_size / 2, 0);  // 4 x 1

        Eigen::MatrixXf transformed_points; // 4 x n
        double initial_cost =
            evaluateCost(cluster.initial_pose.homogeneous,
                         cluster.merged_data_h, template_bound, transformed_points);
        int status = 1;
        ...
        {0.01, 0.01, 0.01, 0.01, 0.01, 0.01}; // tx, ty, tz, r, p, y
